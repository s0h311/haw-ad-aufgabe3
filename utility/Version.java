...
public class Version implements Serializable {
  ...
  final static private long encodedV2 = 2___00002_010___2023_09_24__01L; // "V2" ::= V^2 = (class) Version Version  resp. Version of the class Version
   ...
   */
  static public String getDecodedV2() {
  ...
  public Version(final long encodedVersion) {
    if (!isCodingValid(encodedVersion)) {
      throw new IllegalArgumentException("Faulty coding of version");
    }
